...
<h4 style="display: inline-block; color: white; margin: 5px;">Smart Shopping Cart (Developed By Team <b>SSIT</b>)</h4>
</nav>
</div>
</header>
...
<div class="container-fluid">
	<div class="row">
		...
		<h3 style="text-align: center; margin: 10px;"><i class="fas fa-laptop-code"></i>&nbsp;&nbsp;Product Detection &&nbsp;&nbsp;<i class="fa fa-file-invoice"></i>&nbsp;&nbsp;Bill Generation</h3>
		</div>
	</div>
	<div class="row" style="background: whitesmoke;">
		...
		<div class="col col-md-6" style="background: black;">
			...
			<button class="btn btn-danger float-right" style="margin: 15px; background-color: #469db3">
			<span class="spinner-grow spinner-grow-sm" role="status" aria-hidden="true"></span>
			<i>Live Stream</i>
			</button>
			<div style="text-align: right; padding: 0px; 10px;">
				<img src="http://192.168.29.162:8080/video">
			</div>
		</div>
	</div>
</div>
